...
function aquaar_script_enqueue() {
    ...
    wp_enqueue_style('customstyle', get_template_directory_uri() . '/css/main.min.css', array(), '1.1.9.', 'all');
	...
	wp_enqueue_script('customjs', get_template_directory_uri() . '/js/script.min.js', array(), '1.2.5', true);
